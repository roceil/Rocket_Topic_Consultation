...
export default function CounselorCard({ name, rankTag }: ISuggestCounselorCardProps) {
  return (
    <div className="p-[36px]">
      <div className="max-w-[244px] lg:max-w-[280px]">
        ...
        <div className="flex items-center justify-between px-2">
          ...
          <div className="rounded border border-primary bg-white py-1 px-3 lg:py-2 lg:px-4">

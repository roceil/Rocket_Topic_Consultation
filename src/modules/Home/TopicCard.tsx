...
export default function TopicCard({ gap, type, text }: ITopicCardProps) {
  return (
    <li
    ...
    >
      {/* 這是圖片 */}
      <div className="h-[80px] w-[80px] rounded-2xl border border-b-0 border-secondary bg-secondary lg:h-[286px] lg:w-[316px] lg:rounded-b-none" />

        ...
        <div className='lg:flex lg:justify-between '>
          ...
          <ul className='flex flex-col items-center lg:w-[704px] lg:flex-row lg:flex-wrap  lg:items-start lg:justify-between'>
            <li className='flex flex-col items-center'>
              {/* 這裡是圖片 */}
              <div className='h-[360px] w-[280px] rounded bg-secondary lg:block lg:h-[415px] lg:w-[328px]'></div>
            ...
            <li className='mt-8 flex flex-col items-center lg:mt-[182px] lg:mb-11'>
              {/* 這裡是圖片 */}
              <div className='h-[360px] w-[280px] rounded bg-secondary lg:block lg:h-[415px] lg:w-[328px]'></div>
              <p className='mt-1 w-full text-left text-xl font-bold text-primary-heavy lg:mt-3'>
                Step2
            ...
            <li className='mt-8 flex flex-col items-center lg:mt-[-182px]'>
              {/* 這裡是圖片 */}
              <div className='h-[360px] w-[280px] rounded bg-secondary lg:block lg:h-[415px] lg:w-[328px]'></div>
              <p className='mt-1 w-full text-left text-xl font-bold text-primary-heavy lg:mt-3'>
                Step3

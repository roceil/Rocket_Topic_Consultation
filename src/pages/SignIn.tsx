// 待修改：
// 表單 label padding 還沒改
// PC 表單格線有問題
// PC 左側底圖，要重新定位、高度要自適應
...
export default function SignIn (){
  ...
  >
    ...
    <Form.Item
      ...
      {...tailFormItemLayout}
    >
      <Checkbox className='mt-[84px]'>
      我已同意 <a href="">隱私權條款</a>
      </Checkbox>
    </Form.Item>
    <Form.Item {...tailFormItemLayout}>
      <Button type="default" htmlType="submit" className='bg-[#D4D2E3] text-white h-[56px] w-[380px] rounded-[30px] text-base '>
      立即註冊
      </Button>
    </Form.Item>
    </Form>,</>},
  ...
  return(
    <>
    <div className='hidden lg:block w-[416px] h-[1220px] bg-[#D4D2E3] absolute -z-[99]'></div>
    {/* PC 左側底圖 */}
    <div className="z-10 container flex">
      {/* 圖片 */}

      ...
      <section className='lg:container lg:flex lg:justify-between lg:py-[148px]'>
              ...
              <div className='flex flex-col items-center '>
                ...
                <div className=' relative w-full max-w-[340px] rounded-2xl bg-bg2 px-11 pt-[60px] pb-12 lg:hidden'>
                  ...
                  <div className='flex justify-center space-x-4'>
                    <button className='w-[104px] rounded-full border border-primary-heavy py-3 text-sm text-primary-heavy'>
                      我有問題
                    </button>

                    <button className='w-[104px] rounded-full border border-primary-heavy bg-primary-heavy py-3 text-sm text-white'>
                      手刀預約
                    </button>
                  </div>

                  <button className='absolute top-0 left-1/2 w-[135px] -translate-x-1/2 translate-y-[-23px] rounded-full border border-x-secondary bg-white py-3 text-sm text-primary-heavy'>
                    親密關係
                  </button>
                </div>
              </div>
        ...
        <div className='hidden lg:block lg:pt-[226px]'>
          ...
          <div className='relative w-full max-w-[340px] rounded-2xl bg-bg2 px-11 pt-[60px] pb-12 lg:max-w-[388px] lg:px-14 lg:pt-[78px] lg:pb-14'>
            <button className='absolute top-0 left-1/2 w-[135px] -translate-x-1/2 translate-y-[-23px] rounded-full border border-x-secondary bg-white py-3 text-sm text-primary-heavy lg:w-[240px]  lg:translate-y-[-35px] lg:py-5 lg:text-xl'>
              親密關係
            </button>
            ...
            <div className='flex justify-center space-x-4'>
              <button className='w-[104px] rounded-full border border-primary-heavy py-3 text-sm text-primary-heavy lg:w-[144px] lg:py-4 lg:text-base'>
                我有問題
              </button>

              <button className='w-[104px] rounded-full border border-primary-heavy bg-primary-heavy py-3 text-sm text-white lg:w-[144px] lg:py-4 lg:text-base'>
                手刀預約
              </button>
            </div>
          </div>
